###############################################################
# $Id: 72_FRITZBOX.pm 9881 2015-11-13 17:16:26Z grompo $
#
#  72_FRITZBOX.pm 
#
...
# stop if certain perl moduls are missing
   ...
   $hash->{INTERVAL}           = 300; 
   $hash->{fhem}{modulVersion} = '$Date: 2015-11-13 18:16:26 +0100 (Fri, 13 Nov 2015) $';
...
# Use old sid if last access later than 9.5 minutes
   ...
   if ($sid) {
      FRITZBOX_Log $hash, 4, "Web session opened with $sid";
      return $sid;
   } 
